...
from tensorflow.keras.layers import  Conv2D, MaxPooling2D, concatenate, add, GlobalMaxPooling2D, GaussianNoise, Concatenate
import data
...
from utils_gan import tensor2numpy
